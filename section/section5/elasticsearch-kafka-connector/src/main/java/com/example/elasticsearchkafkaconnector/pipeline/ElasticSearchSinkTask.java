package com.example.elasticsearchkafkaconnector.pipeline;

import com.example.elasticsearchkafkaconnector.pipeline.config.ElasticSearchSinkConnectorConfig;
